...
from audio import load_audio, get_audio_length, audio_with_sox, augment_audio_with_sox, load_randomly_augmented_audio
import logging
...
class SpectrogramDataset(Dataset, SpectrogramParser):
    ...
    def __getitem__(self, index):
        ...
        spect = self.parse_audio(audio_path)[:,:4000]
